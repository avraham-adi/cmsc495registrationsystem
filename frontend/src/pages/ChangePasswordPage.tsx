...
export function ChangePasswordPage() {
	...
	return (
		<div className="auth-layout auth-password-layout">
			<div className="auth-password-shell">
				<section className="auth-card auth-card-wide auth-password-card">
					...
					{requiresPasswordChange ? (
						<div className="messageinfo auth-password-message">
							<strong>Welcome to GURU!</strong> <br /> Change your password to finish account setup.
						</div>
					) : null}
